            ...
            >
              ...
              <div className="p-6 text-left flex flex-col gap-4 flex-grow">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 text-amber-500 text-xs font-semibold font-mono">
                ...
                {/* Info parameters */}
                <div className="flex flex-col gap-2 border-t border-b border-slate-100 py-4 font-mono text-[11px] text-slate-600">
                  <div className="flex justify-between">
                    <span>Clinical Experience:</span>
                    <strong className="text-slate-800">{doc.experience}</strong>
                  </div>
                  <div className="flex justify-between">
                    <span>Consultation Pricing:</span>
                    <strong className="text-purple-600">${doc.consultationFee} / session</strong>
                  </div>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-wrap gap-1 justify-end max-w-[160px]">
                      {doc.availability.map((day) => (
                        <span key={day} className="px-1.5 py-0.5 rounded bg-purple-500/5 text-[9px] font-semibold text-slate-700 uppercase tracking-wide border border-purple-500/10">{day.substr(0, 3)}</span>
                      ))}
                    </div>
                  </div>
                </div>
